...
{  
  ...
  if ($flag==1) 
  {
    if(isset($_POST["submit"]))  
    {
      ...
      {
        if(addDoctorData($encrypted_password))
        {
          echo 'Doctor Registration Completed';
        }
      }
      if($_POST["category"]=="Patient")
      {
        if(addPatientData($encrypted_password))
        {
          echo 'Patient Registration Completed';
        }
      }
      if($_POST["category"]=="Receptionist")
      {
        if(addReceptionistData($encrypted_password))
        {
          echo 'Receptionist Registration Completed';
        }
      }
    }  
  }
